...
while current_date_time.jd < start_date_time.jd + stop_time_days:
    ...
    ss1.update_states(current_date_time, dt_secs, sun, mercury, venus, earth, mars, jupiter, saturn, uranus, neptune,
                      pluto)
    ss2.update_states(current_date_time, dt_secs, sun, mercury, venus, earth, mars, jupiter, saturn, uranus, neptune,
                      pluto)
